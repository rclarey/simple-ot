import { Operation, Insert, Delete } from 'types';
 ...
 */
export const inclusionTransform = (op1: Operation, op2: Operation): Operation => {
  if (op1.isNoop) {
 ...
 * @returns {Operation} the result of op1 transformed against op2
 */
export const exclusionTransform = (op1: Operation, op2: Operation): Operation => {
  if (op1.isNoop) {
    if (
